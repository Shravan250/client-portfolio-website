    ...
    <g id="Loading4" clipPath="url(#clip0_267_432)">
      ...
      <g id="Ellipse 316" filter="url(#filter0_f_267_432)">
        <motion.ellipse
          ...
          ry={254.5}
          fill="#1C6BFF"
          initial={{ cx: 1156 }} // Starting position
          animate={{ cx: 756 }} // Follow Rectangle 3279
          transition={{
            duration: 2,
            ease: "easeInOut",
            type: "keyframes",
      ...
      <g id="Ellipse 317" filter="url(#filter1_f_267_432)">
        <motion.ellipse
          ...
          ry={278.5}
          fill="#0075FF"
          initial={{ cx: 356 }} // Starting position
          animate={{ cx: 756 }} // Follow Rectangle 3277
          transition={{
            duration: 2,
            ease: "easeInOut",
            type: "keyframes",
      ...
      >
        <rect y={134} width={6} height={498} fill="#1C6BFF" />
      </motion.g>
      <motion.rect
        id="Rectangle 3277"
        // x={753}
      ...
      >
        <rect y={134} width={6} height={498} fill="#0075FF" />
      </motion.g>
      <motion.rect
        id="Rectangle 3279"
        // x={753}
