...
const SingleProduct = () => {
  ...
  const { productIndex } = location.state || {}; // Get productIndex from state
          ...
          <div className="tv-left-placement">
            <div className="SP-image-parent">
              ...
              <div className="image-group">
                {currentProduct?.imageSrc?.map((images, index) => (
                  <img
                    key={index}
                ...
                <div className="image-group-more-wrapper">
                  <p className="image-group-more">+2 more</p>
                </div>
              </div>
            </div>
            {isTablet && (
          ...
          <div className="SP-selected-product-info-container">
            ...
            <div className="selected-product-info-div">
              ...
              <div className="SP-frame-parent2">
                <div className="SP-frame-parent3">
                  <div className="SP-frame-parent4">
                    ...
                    <img className="chevron-right-icon" alt src={up} />
                  </div>
                  <div className="it-will-be-installed-behind-yo-wrapper">
                    <div className="SP-info-upgrade-your-home">
                      It will be installed behind your existing switchboard, it
                      doesn't require any additional wiring & physical damage of
                      wall. it gives you power to control all your household
                      appliances like Light, Fan, AC, Cooler etc through your
                      Mobile phone, Through Remote and even with your voice with
                      Alexa/Google Home, While Seating On Sofa or Bed.
                    </div>
                  </div>
                </div>
                <div className="SP-frame-parent5">
                  <div className="question-mark-parent">
                    <img
                      className="question-mark-icon"
                      alt
                  ...
                  <img className="chevron-right-icon" alt src={down} />
                </div>
              </div>
            </div>
          </div>
